...
export default function Settings() {
  ...
  // Roles & Permissions Matrix State matching the screenshot
  ...
  const settingsCategories = [
    { name: 'Personal Settings', icon: personalProfileIcon },
          ...
          <div className="max-w-7xl mx-auto space-y-6 text-left">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-6 pt-1">
              ...
              <div className="flex-1 w-full space-y-6 text-left">
                ...
                {/* 1. PERSONAL SETTINGS PANEL (Exact Match to Screenshot) */}
                <div id="personal-settings" className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 pt-2">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-xs sm:text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-gray-400 bg-white transition"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex border border-gray-300 rounded-lg overflow-hidden focus-within:border-gray-400 bg-white transition">
                        <span className="px-3.5 py-2.5 bg-gray-50 text-gray-700 text-xs sm:text-sm border-r border-gray-300 font-medium">
                          +91
                        </span>
                        <input
                          type="tel"
                          ...
                          onChange={handleInputChange}
                          placeholder=""
                          className="w-full px-4 py-2.5 text-xs sm:text-sm text-gray-800 placeholder-gray-400 focus:outline-none bg-transparent"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        value={formData.role}
                        readOnly
                        className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-xs sm:text-sm text-gray-700 bg-gray-50/50 focus:outline-none cursor-default"
                      />
                    </div>
                  ...
                  <div className="flex justify-end pt-4">
                    <button
                      type="button"
                      onClick={handleSave}
                      className="bg-[#D71920] hover:bg-[#B9151B] text-white text-xs sm:text-sm font-semibold px-6 py-2.5 rounded-lg shadow-sm transition cursor-pointer"
                    >
                      Save Profile
                    </button>
                  </div>
                ...
                {/* 2. ROLES & PERMISSIONS PANEL (Directly Below Personal Settings) */}
                ...
                {/* 3. GENERAL SETTINGS PANEL (Directly Below Roles & Permissions) */}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
                    ...
                    <div className="space-y-5">
                      <div className="border-b border-gray-200 pb-2">
                        <span className="text-xs sm:text-sm font-semibold text-gray-700">Localization</span>
                      </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 rounded-lg px-4 py-2.5 pr-8 text-xs sm:text-sm text-gray-800 cursor-pointer shadow-2xs focus:outline-none"
                          >
                          ...
                          <img
                            src={Dropdown}
                            alt="dropdown"
                            className="w-2.5 h-2 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none object-contain"
                          />
                        </div>
                      </div>
                      ...
                      <div className="pt-2 space-y-3">
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="w-24 h-14 sm:w-28 sm:h-16 rounded-lg bg-[#C8BCB3] overflow-hidden flex items-center justify-center text-gray-700 text-xs sm:text-sm font-medium border border-gray-200 shrink-0">
                            {companyLogo ? (
                          ...
                          <div className="space-y-1.5">
                            ...
                            <label className="bg-[#D71920] hover:bg-[#B9151B] text-white text-xs font-semibold px-4 py-1.5 rounded-md cursor-pointer transition shadow-sm inline-block">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="space-y-4 pt-1">
                        {/* Email Notifications */}
                        <div
                          onClick={() => setGeneralNotifications((prev) => ({ ...prev, email: !prev.email }))}
                          className="flex items-center space-x-3 cursor-pointer group select-none"
                        >
                          <div
                            className={`w-5 h-5 rounded-[3px] flex items-center justify-center transition shrink-0 ${
                          ...
                          <span className="text-xs sm:text-sm font-semibold text-gray-900">Email Notifications</span>
                        </div>

                        {/* SMS Alerts */}
                        <div
                          onClick={() => setGeneralNotifications((prev) => ({ ...prev, sms: !prev.sms }))}
                          className="flex items-center space-x-3 cursor-pointer group select-none"
                        >
                          <div
                            className={`w-5 h-5 rounded-[3px] flex items-center justify-center transition shrink-0 ${
                          ...
                          <span className="text-xs sm:text-sm font-semibold text-gray-900">
                            SMS Alerts <span className="text-gray-400 font-normal text-xs">(Critical Only)</span>
                          </span>
                        </div>

                        {/* In-App Notifications */}
                        <div
                          onClick={() => setGeneralNotifications((prev) => ({ ...prev, inApp: !prev.inApp }))}
                          className="flex items-center space-x-3 cursor-pointer group select-none"
                        >
                          <div
                            className={`w-5 h-5 rounded-[3px] flex items-center justify-center transition shrink-0 ${
                          ...
                          <span className="text-xs sm:text-sm font-semibold text-gray-900">In-App Notifications</span>
                        </div>
                      </div>
                ...
                {/* 4. SECURITY PANEL (Directly Below General Settings) */}
                <div id="security" className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-6 text-left">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
                    ...
                    <div className="space-y-4">
                      <div className="border-b border-gray-200 pb-2">
                        <span className="text-xs sm:text-sm font-semibold text-gray-700">Change Password</span>
                      </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full border border-gray-300 rounded-lg px-4 py-2.5 pr-10 text-xs sm:text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-gray-400 bg-white shadow-2xs"
                          />
                          <button
                            type="button"
                            onClick={() => setShowPassword({ ...showPassword, current: !showPassword.current })}
                            className="absolute right-3 top-1/2 -translate-y-1/2 p-1 hover:opacity-70 transition cursor-pointer"
                            aria-label="Toggle password visibility"
                          >
                            <img src={eyeOffIcon} alt="view" className="w-4 h-4 object-contain" />
                          </button>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="border-b border-gray-200 pb-2">
                        <span className="text-xs sm:text-sm font-semibold text-gray-700">Two-Factor Authentication</span>
                      </div>
                      ...
                      <div className="pt-2">
                        <div className="border border-gray-300 rounded-full px-5 py-2.5 flex items-center justify-between max-w-sm bg-white shadow-2xs">
                          <span className="text-xs sm:text-sm font-medium text-gray-800">Authenticator App</span>
                          <button
                            type="button"
                            onClick={() => setIs2FAEnabled(!is2FAEnabled)}
                            className={`w-10 h-5 sm:w-11 sm:h-6 rounded-full p-0.5 transition-colors duration-200 ease-in-out cursor-pointer flex items-center ${
                              is2FAEnabled ? 'bg-[#374151]' : 'bg-gray-300'
                            }`}
                            aria-label="Toggle Authenticator App"
                          >
                            <div
                              className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white shadow-md transform transition-transform duration-200 ease-in-out ${
